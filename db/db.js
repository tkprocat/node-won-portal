...
if (!exists) {
    ...
    db.serialize(function () {
        ...
        db.run('CREATE TABLE computers (id integer PRIMARY KEY, name char(50), ip char(15), mac char(17))');
        db.run('INSERT INTO users VALUES (?, ?, ?)', [null, 'admin', require('crypto').createHash('sha256').update('secret').digest('hex')]);
        db.run('INSERT INTO computers VALUES (?, ?, ?, ?)', [null, 'WOPR', '192.168.0.20', '01-23-45-67-89-ab']);
    });
}
